# -*- coding: utf-8 -*-
"""
Created on Mon Aug 27 11:43:21 2018
...
#    ctxt = PyV8.JSContext()
#    ctxt = execjs.JSContext()
#    ctxt.enter()
    func = execjs.eval("({js})".format(js=js_func_string))
    return func(arg)
...
# """
first_html = (" ".join('%s' %id for id in first_html))
print(type(first_html))
# 提取其中的JS加密函数
